...
void UBTSteeringService::TickNode(UBehaviorTreeComponent & OwnerComp, uint8 * NodeMemory, float DeltaSeconds)
{
	...
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, FString("Set Steering  ") + FString::SanitizeFloat(SteeringValue));

	//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, FString("Set Throttle  ") + FString::SanitizeFloat(ThrottleValue));
}
